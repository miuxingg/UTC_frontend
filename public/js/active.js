...
(function ($) {
  ...
  const stickyHeader = () => {
    $(window).on('scroll', () => {
      const sticky_menu = $('.sticky__header');
      const pos = sticky_menu.position();
      if (sticky_menu.length) {
        // const windowpos = sticky_menu.top;
        $(window).on('scroll', () => {
  ...
  $('.gallery__masonry__activation').imagesLoaded(function () {
    ...
    // init Isotope
    const $grid = $('.masonry__wrap').isotope({
